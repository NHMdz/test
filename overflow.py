...
def show_singer_message():
    ...
    win.title("Memory overflow error")
    ...
    label = tk.Label(frame, text="Miss you", font=("Helvetica", 15, "bold"), bg="pink") 
...
background_image_path = 'clover.jpg' 
...
button = tk.Button(root, text="Click here", command=show_message, **button_style)
